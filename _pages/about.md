---
permalink: /
title: "Welcome to Nasir's website"
author_profile: true
redirect_from: 
  - /about/
  - /about.html
---
I am a graduate researcher in **Applied and Computational Mathematics** at **Old Dominion University (ODU)** in **Norfolk, Virginia**, where I am currently pursuing my **Ph.D. (2023–Present)**. My academic interests broadly span **scientific computing, numerical modeling, and machine learning**, with a focus on developing **accurate, efficient, and scalable computational approaches** for complex systems. My research interests include **scientific computing and numerical analysis**, **high-performance computational methods**, and **machine-learning-enabled modeling**, with an emphasis on designing **stable, accurate, and scalable algorithms** for complex mathematical and physical systems.

My technical background includes **Python, MATLAB, R, C++, and Fortran**, with experience in **CUDA** and Linux-based scientific computing workflows. I have worked on computational projects involving **high-performance numerical simulation** and **computational modeling**, including contributions to funded research Projects.

I hold an **M.S. in Applied and Computational Mathematics** from **ODU (2023–2025)** and previously earned an **M.S. in Mathematics** from **COMSATS University Islamabad** as well as a **B.S. in Mathematics** from the **International Islamic University Islamabad**.

In addition to research, I support undergraduate learning at ODU as a **Supplemental Instruction (SI) Leader (Fall 2023–Present)**, where I facilitate problem-solving sessions and provide academic support through the **Applied Calculus Lab**, the **SMART Room**, and **online tutoring**. My technical background includes **Python, MATLAB, R, C++, and Fortran**, with experience in **CUDA** and Linux-based scientific computing workflows.
...
My research experience includes work on funded projects in both Pakistan and South Korea. At the **Applied Fluid Laboratory (KNU), South Korea** (Apr 2022–Aug 2023), I contributed to an **NRF-funded project** involving high-Reynolds-number flow simulations using the **Lattice Boltzmann Method (LBM)** and the development of **GPU-accelerated C++ solvers** for oscillating-wing energy recovery applications. Earlier, at **COMSATS University Islamabad** (Jan 2020–Apr 2022), I worked as a Research Assistant on an **HEC-funded project**, developing SRT-LBM simulations in **Fortran** and performing post-processing and visualization in **MATLAB** and **Tecplot**. 
